...
def test_rtc():
    cmd1 = 'q\r\n'
    cmd2 = 'rtc\r\n'
    testlib.inputStr(cmd1, plc_tab)
    testlib.inputStr(cmd2, plc_tab)
    ...
    for arm_cmd in arm_cmds:
        ...
        testlib.inputStr('%s\r\n' % (arm_cmd), arm_tab)
        testlib.logTestPop('rtc_int_from_arm 0', testlib.logTest2, ['pass'], ['fail'])
        testlib.inputStr('q\r\n', arm_tab)
...
def test_adc():
    ...
    testlib.runCase('adc_cm 0 2400000 0xff',
                    passlist=['cmd:>'], failstr='$$$$$$$$')
